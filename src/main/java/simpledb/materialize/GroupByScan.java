...
public class GroupByScan implements Scan {
    ...
    public boolean next() {
        ...
        for (AggregationFn fn : aggfns) fn.processFirst(s);
        ...
        while (moregroups = s.next()) {
            ...
            for (AggregationFn fn : aggfns) fn.processNext(s);
        }
        return true;
    }
    ...
    public Constant getVal(String fldname) {
        ...
        for (AggregationFn fn : aggfns) if (fn.fieldName().equals(fldname)) return fn.value();
