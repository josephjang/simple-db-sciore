...
public class CreateStudentDB {
    public static void main(String[] args) {
        ...
        try (Connection conn = d.connect(url, null);
            ...
            for (int i = 0; i < studvals.length; i++) stmt.executeUpdate(s + studvals[i]);
            ...
            for (int i = 0; i < deptvals.length; i++) stmt.executeUpdate(s + deptvals[i]);
            ...
            for (int i = 0; i < coursevals.length; i++) stmt.executeUpdate(s + coursevals[i]);
            ...
            for (int i = 0; i < sectvals.length; i++) stmt.executeUpdate(s + sectvals[i]);
            ...
            for (int i = 0; i < enrollvals.length; i++) stmt.executeUpdate(s + enrollvals[i]);
